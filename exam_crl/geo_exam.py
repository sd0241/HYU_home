...
df_result.to_sql(name='apartzz', con=connection, if_exists='append', index= False)
...
df_result.to_csv('./web_total_apt.csv', encoding='utf-8-sig', index=False)
df_result = pd.read_csv('./web_total_apt.csv')
